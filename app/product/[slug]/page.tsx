            ...
            <div className='grid gap-8 md:grid-cols-2'>
                ...
                <div className='md:py-8'>
                    <div className='mb-2 md:mb-3'>
                        ...
                        <span className='text-gray-400 tracking-tighter inline-block mb-0.5 italic'>{data.categoryName}</span><span className=' text-gray-400 tracking-tighter'>/{data.name}</span>
